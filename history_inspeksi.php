...
<html lang="en">
    <head>
        ...
        <title>List Rencana Kirim</title>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr style="height:10px">
                                ...
                                <td>lo</td>
                                <td>low</td>
                                <td><a href="detail_history_inspeksi.php" target="_self">View</a></td>
                                <td><a href="detail_inspeksi_gantung.php" target="_self">Edit</a></td>
                                <td>Aktif</td>
                            </tr>
                        </table>
