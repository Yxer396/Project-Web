...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <a class="navbar-brand" href="#">Master Jenis Bongkar Muat</a>
        <!-- Navbar Search-->
                        ...
                        <div class="modal-content">
                            ...
                            <form method='post'>
                                <div class="modal-body">
                                    <input type="text" name="idbongkarmuat" placeholder="Masukan ID" class="form-control" required>
                                    <br>
                                    <input type="text" name="activity" placeholder="Activity" class="form-control" required>
                                    <br>
