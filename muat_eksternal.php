...
<body class="sb-nav-fixed">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="50%" cellspacing="0">
                                        <tr>
                                            <td>
                                                ...
                                                <select name="staff">
                                                    <?php
                                                    $takealldata = mysqli_query($conn, "select * from staff where jabatan = 'staff';");
                                                    while ($fetcharray = mysqli_fetch_array($takealldata)) {
                                                        $takename = $fetcharray['nama_staff'];
                                                        $takeid = $fetcharray['no_staff'];
                                                    ?>
                                                        <option value="<?= $takeid; ?>"><?= $takename; ?></option>
                                                    <?php
                                                    }
                                                ...
                                                <select name="operator">
                                                    <?php
                                                    $takealldata = mysqli_query($conn, "select * from staff where jabatan = 'operator';");
                                                    while ($fetcharray = mysqli_fetch_array($takealldata)) {
                                                        $takename = $fetcharray['nama_staff'];
                                                        $takeid = $fetcharray['no_staff'];
                                                    ?>
                                                ...
                                                <select name="helper">
                                                    <?php
                                                    $takealldata = mysqli_query($conn, "select * from staff where jabatan = 'helper';");
                                                    while ($fetcharray = mysqli_fetch_array($takealldata)) {
                                                        $takename = $fetcharray['nama_staff'];
                                                        $takeid = $fetcharray['no_staff'];
                                                    ?>
    ...
    <script>
        function timeLapor() {
            ...
            document.getElementById("lapor").innerHTML = '<input type="hidden" name="lapor" value = "' + timenow + '">';
        }
    </script>
    <script>
        function timeMulai() {
            ...
            document.getElementById("mulai").innerHTML = '<input type="hidden" name="mulai" value = "' + timenow + '">';
        }
    </script>
    <script>
        function timeSelesai() {
            ...
            document.getElementById("selesai").innerHTML = '<input type="hidden" name="selesai" value = "' + timenow + '">';
        }
    </script>
    <script>
