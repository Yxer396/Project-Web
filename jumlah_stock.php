                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <tr>
                                ...
                                <td>
                                    <label for="tgl_mulai" style="font-size: 12px;">Date Form : </label>
                                    <input type="text" name="tgl_mulai" size="20"><br>
                                    <label for="tgl_to" style="font-size: 12px;">To : </label>
                                    <input type="text" name="tgl_to" size="20"><br>
